...
export const customerValidationSchema = object({
  ...
  // telephone: optionalPhoneValidator,
  telephone: pipe(
    string(requiredMsg),
  ...
  customerGroupId: pipe(string(invalidMsg), nonEmpty(requiredMsg)),
  ...
  customerPriceId: optional(numberValidator),
  ...
  creditLimit: optional(numberValidator),
