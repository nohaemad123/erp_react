...
export const salesReturnInvoiceValidationSchema = object({
  ...
  salesManId: string(requiredMsg),
  salesInvoiceHeadId: string(requiredMsg),
  invoiceType: nullish(numberValidator),
